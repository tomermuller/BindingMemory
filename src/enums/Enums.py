...
class RealTimeInstruction:
    ...
    COUPLE_LEARNING_INSTRUCTION = ("כעת שלב הלמידה.\n"
                                   "בכל סיבוב תראה/י פועל ואחריו תמונה.\n"
                                   "נסה/י לקשר בין הפועל לתמונה שתופיע.\n"
                                   "אך לפני הנה 2 דוגמאות:\n"
                                   "(אנא לחץ/י על כל כפתור כדי להתחיל)")

    RETRIVAL_COUPLE_INSTRUCTION = ("כעת שלב המבחן.\n"
                                   "תראה/י פועל - נסה/י לזכור את התמונה שהופיעה איתו.\n"
                                   "אם זכרת, לחץ/י על חץ למעלה.\n"
                                   "לאחר מכן בחר/י את הצבע והחדר שהופיעו עם הפועל.\n"
                                   "אך לפני הנה 2 דוגמאות:\n"
                                   "(אנא לחץ/י על כל כפתור כדי להתחיל)")
