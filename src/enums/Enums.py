...
class Instruction:
    WELLCOME = ("ברוך הבא/ה לניסוי!\n"
                "הניסוי מורכב מ2 שלבים:\n\n"
                "1.שלב התמונות החוזרות.\n"
                "2.שלב הלמידה והמבחן.\n"
    ...
    FIRST_PHASE_INSTRUCTION = ("\n\nבשלב הראשון תראה/י תמונות של אובייקטים. בכל שלב יופיע על המסך אובייקט אחד לכמה שניות."
                               "\n\nלאחר מכן תתבקש לסמן האם האובייקט היה חי או דומם."
                               "\n\n הסימון יתבצע בעזרת לחצני החצים במקלדת."
                               "\n\nאך לפני שנתחיל בניסוי עצמו הנה 2 דוגמאות:"
                               "(אנא לחץ/י על כל כפתור כדי להתחיל את הדוגמאות)")
...
class RealTimeInstruction:
    ...
    COUPLE_LEARNING_INSTRUCTION = ("כעת שלב הלמידה.\n"
                                   ...
                                   "עליך ללמוד את הצימוד בין השניים.\n"
                                   "לאחר כ2 שניות תוכל לסמן שהצימוד נכרש בעזרת החץ העליון ^ במקלדת\n"
                                   "אך לפני שיתחיל הנסוי הנה 2 דוגמאות:\n"
                                   "(אנא לחץ/י על כל כפתור כדי להתחיל)")

    RETRIVAL_COUPLE_INSTRUCTION = ("כעת שלב המבחן.\n"
                                   "תראה/י פועל - נסה/י להיזכר באובייקט שהופיעה איתו.\n"
                                   "אם נזכרת, לחץ/י על חץ למעלה והמשיכ\י ולחשוב על האובייקט גם כאשר הפועל נעלם מן המסך.\n"
